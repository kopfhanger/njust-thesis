...
// Template adaptation: keep the official diagram structure while using the
// thesis font contract instead of introducing New Computer Modern.
#set text(white, font: "Times New Roman")
